...
temp_dir=tempdir
outdir=outdir
gcs_url="gs://prod-ai-lab-speech-bucket/longtou/tmp/commboosk/wds_v2_mfa"
beam=10
retry_beam=40

. parse_options.sh

shard_urls=$(ls /home/longtou.2024/mount/longtou/db/commbooks/wds_v2/* | head -n4)
...
python lt_scripts/build_wds_mfa.py /home/longtou.2024/mount/longtou/db/commbooks/wds_v2/shard-000000.tar \
    $dictionary_path \
    $acoustic_model_path \
    $g2p_model_path \
    $outdir \
